...
<br><br>
★★★★★ : 아직 내 수준에선 정의하지 못함.<br>
           개인적으로 기술을 배움에 끝이 없기 때문에 완전한 마스터 단계가 있을까 싶음<br>
           물론 특정 목적(코딩테스트, 데이터 분석, 서버 구축, 라이브러리 제작 등)으로의 활용 능력 및 이해도는 <br>
           마스터 할 수 있다고 볼 수 있겠으나, 지금 이시간에도 끝없이 새로운 활용법이 쏟아져 나오고 있음<br>
</div>
</details>
