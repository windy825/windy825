...
<br>
★★★★★ : 아직 내 수준에선 정의하지 못함.<br><br>
           개인적으로 기술을 배움에 끝이 없기 때문에 완전한 마스터 단계가 있을까 싶음<br><br>
           물론 특정 목적(코딩테스트, 데이터 분석, 서버 구축, 라이브러리 제작 등)으로의 활용 능력 및 이해도는 <br><br>
           마스터 할 수 있다고 볼 수 있겠으나, 지금 이시간에도 끝없이 새로운 활용법이 쏟아져 나오고 있음<br><br>
</div>
</details>
...
| :----------: | :-----------------: | :----------------------------------------------------------: |
|  **Python**  |        ★★★★☆        | 언어 특징과 내부 동작 과정, 객체지향을 이해를 바탕으로, 함수와 클래스 등 능숙히 활용 |
|   **C++**    |        ★☆☆☆☆        | 현재 학습중인 언어이나, 프로그래밍 언어에 대한 이해를 바탕으로 빠르게 습득 가능 |
...
|                  **Camera 영상 처리**                   |        ★★☆☆☆        | openCV 와 openGL을 활용한 2D TOP VIEW 및 2.5D BOWL VIEW 제작 경험<br />Computer graphics 지식과 Camera Calibration 이해를 바탕으로 <br />카메라 센서로 얻은 영상 적극 활용 가능 <br />**아직 진행중인 파트** |
